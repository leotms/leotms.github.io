...
If you're curious and wanna to give a follow to our bot, just go check [PapiBot on Twitter](https://twitter.com/botmepapi). We are continously adding new verbs, when it reaches a certain point we'll release its verb list so other people can use them to create more interesting and funny things too!